...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-amber-300 text-left text-base font-medium text-amber-300 bg-indigo-50 focus:outline-none focus:text-amber-400 focus:bg-indigo-100 focus:border-amber-500 transition duration-150 ease-in-out'
